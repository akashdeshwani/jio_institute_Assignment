...
d3.csv("/data/cat_profit.csv").then(function(data){
    
    xScale.domain(data.map(function(d){ return d.category;}));
    yScale.domain([0,d3.max(data,function(d){return d.profit;})]);
    ...
    .attr("y",function(d){return yScale(d.profit);})
    .attr("width",xScale.bandwidth()+15)
    .attr("height",function(d){return height-yScale(d.profit);})
